...
onnx_model_marks = os.path.join(script_dir, "Dependencies2","model_q1-q11_v4")#"model_q1-q11_v7_no_aug.onnx")#model_q1-q11_v4.onnx")# "model_q1-q11_v5.onnx")#"model_q1-q11_v4.onnx")#"model_q1-q11_v3.onnx")  
                ...
                try:
                    ...
                    with conn:
                        with conn.cursor() as cursor:
                            ...
                            columns = ['Filename'] + ['Scanno'] + db_column_name + ['updation']+['Flag'] +["Total_Attempted_Column"]
